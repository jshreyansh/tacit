export const en = {
  ...
  canvas_empty_eyebrow: "Getting started",
  canvas_empty_line_lead: "Create your first space.",
  canvas_empty_line_call: "Open a folder to work in.",
  onboarding_space_title: "Create your first space",
  onboarding_space_body: "A folder for Tacit to work in.",
  onboarding_space_create: "New folder",
  onboarding_space_create_desc: "Name it and choose where it lives.",
  onboarding_space_open: "Existing folder",
  onboarding_space_open_desc: "Point at a project you already have.",
  onboarding_agent_claude_desc: "Anthropic's coding agent.",
  onboarding_agent_codex_desc: "OpenAI's coding agent.",
  onboarding_browser_action_desc: "Choose which profiles to bring. Chrome needs to be closed.",
  onboarding_rail_title: "Your workspace",
  onboarding_rail_space: "Space",
  onboarding_rail_agent: "Agent",
  onboarding_rail_agent_hint: "Claude or Codex",
  onboarding_rail_agent_none: "No agent",
  onboarding_rail_browser: "Browser profiles",
  onboarding_rail_browser_none: "No profiles",
  onboarding_ready_title: "Your workspace is ready",
  onboarding_ready_one: "One thing happens when you close this.",
  onboarding_ready_two: "Two things happen when you close this, in order.",
  onboarding_ready_import: "Choose your Chrome profiles",
  onboarding_ready_agent: (name: string, space: string) => `${name} opens in ${space}`,
  onboarding_ready_empty: "Your space opens, empty and ready",
  onboarding_start: "Start working",
  onboarding_space_chosen: (name: string) => `Working in ${name}`,
  onboarding_agent_title: "Add an agent",
  onboarding_agent_body: "Claude or Codex, working in your space.",
  onboarding_agent_claude: "Claude",
  onboarding_agent_codex: "Codex",
  onboarding_browser_title: "Bring your browser",
  onboarding_browser_body: "Agents can work in the sites you are already signed in to.",
  onboarding_browser_action: "Import from Chrome",
  onboarding_browser_done: "Imported. Nothing left your Mac.",
  onboarding_skip: "Skip setup",
  onboarding_not_now: "Not now",
  onboarding_next: "Next",
  onboarding_back: "Back",
  onboarding_done: "Done",
  onboarding_browser_handoff: "Chrome import opens next.",
  onboarding_progress: (at: string, of: string) => `Step ${at} of ${of}`,
  ...
  "identity.manager.subtitle": (n: number) =>
    `${n} profile${n === 1 ? "" : "s"}`,
  "identity.manager.setDefaultTooltip": "Open new browser nodes as this profile",
  "identity.manager.rename": "Rename profile",
  "identity.manager.delete": "Delete profile",
  "identity.manager.deleteLastDisabled": "At least one profile must remain",
  "identity.manager.newIdentity": "New profile",
  "identity.manager.newIdentityHint": "starts signed out",
  "identity.manager.setDefaultHint": "Click a name to open new nodes as it",
  "identity.manager.agentLabel": "Agents",
  "identity.manager.agentAllowedOn": (name: string) =>
    `Agents may work as ${name}. Turn off to keep it yours alone.`,
  ...
  browser_identity_manage: "Manage profiles…",
  browser_identity_guest_hint: "Guest — signed out of everything",
  browser_identity_signed_out: "signed out",
  browser_identity_agent_withheld: "Withheld from agents — yours alone",
  browser_identity_agent_withheld_short: "no agents",
  "agentProfile.prompt.title": "Which profile should agents work as here?",
  "agentProfile.prompt.body": (canvas: string) =>
    `Asked once for “${canvas}”. An agent working as a profile can do anything you can in it — send mail as you, post as you. Change it any time in browser profiles.`,
  "agentProfile.prompt.dismiss": "Not now",
  "agentProfile.prompt.dismissHint":
    "Nothing is chosen, and this canvas will not ask again.",
  "agentProfile.prompt.none":
    "No profile is available to agents. Allow one in browser profiles first.",
  "agentProfile.command.setCanvasDefault":
    "Set the agent browser profile for this canvas…",
