export const zh = {
  ...
  browser_find_placeholder: "在页面中查找",
  browser_find_no_match: "无结果",
  browser_find_next: "下一个匹配",
  browser_find_previous: "上一个匹配",
  browser_find_close: "关闭查找",
  ...
  settings_browser_subtitle: "内置浏览器、它使用的账号配置，以及它记录了什么。",
  browser_profiles_label: "浏览器配置",
  browser_profiles_desc: "已导入的 Chrome 配置、哪些智能体可以使用，以及已无归属的存储。",
  browser_profiles_manage: "管理配置",
  browser_activity_label: "已记录的浏览内容",
  browser_activity_desc:
    "在浏览器节点中访问过的页面会写入本机，供之后向智能体提问。这些内容不会发送到任何地方，也不会包含在工作区快照里。",
  browser_activity_none: "暂无记录",
  browser_activity_summary: (entries: string, size: string) =>
    `${entries} 条 · ${size}`,
  browser_activity_erase: "清除",
  browser_activity_erasing: "正在清除…",
  browser_activity_confirm_title: "清除已记录的浏览内容？",
  browser_activity_confirm_body: (entries: string, size: string) =>
    `将从本机删除 ${entries} 条记录（${size}）。智能体将无法再回答关于你已访问页面的问题。你的配置和登录状态不受影响。`,
  browser_activity_confirm: "全部清除",
  browser_activity_erased: "已清除记录的浏览内容。",
  browser_chat_boxes_label: "已记住的输入框",
  browser_chat_boxes_desc: "你曾手动指定过消息输入框的站点，回复会投递到那里。",
  browser_chat_boxes_none: "暂无",
  browser_chat_boxes_count: (n: string) => `${n} 个站点`,
  browser_chat_boxes_forget: "全部忘记",
  ...
  connection_type_inactive_note: "带标记的连线会被记录并绘制，但目前不会真正执行。",
  connection_type_pending_row: "尚未生效",
  ...
  canvas_empty_eyebrow: "开始使用",
  canvas_empty_line_lead: "创建你的第一个空间。",
  canvas_empty_line_call: "打开一个文件夹开始工作。",
  onboarding_space_title: "创建你的第一个空间",
  onboarding_space_body: "一个供 Tacit 工作的文件夹。",
  onboarding_space_create: "新建文件夹",
  onboarding_space_create_desc: "为它命名并选择保存位置。",
  onboarding_space_open: "已有文件夹",
  onboarding_space_open_desc: "指向一个你已经有的项目。",
  onboarding_agent_claude_desc: "Anthropic 的编程智能体。",
  onboarding_agent_codex_desc: "OpenAI 的编程智能体。",
  onboarding_browser_action_desc: "选择要导入的配置。需要先退出 Chrome。",
  onboarding_rail_title: "你的工作区",
  onboarding_rail_space: "空间",
  onboarding_rail_agent: "智能体",
  onboarding_rail_agent_hint: "Claude 或 Codex",
  onboarding_rail_agent_none: "未添加智能体",
  onboarding_rail_browser: "浏览器配置",
  onboarding_rail_browser_none: "未导入配置",
  onboarding_ready_title: "工作区已就绪",
  onboarding_ready_one: "关闭后会发生一件事。",
  onboarding_ready_two: "关闭后会依次发生两件事。",
  onboarding_ready_import: "选择要导入的 Chrome 配置",
  onboarding_ready_agent: (name: string, space: string) => `${name} 将在 ${space} 中打开`,
  onboarding_ready_empty: "你的空间会以空白状态打开",
  onboarding_start: "开始工作",
  onboarding_space_chosen: (name: string) => `工作目录：${name}`,
  onboarding_agent_title: "添加一个智能体",
  onboarding_agent_body: "让 Claude 或 Codex 在你的空间里工作。",
  onboarding_agent_claude: "Claude",
  onboarding_agent_codex: "Codex",
  onboarding_browser_title: "带上你的浏览器",
  onboarding_browser_body: "智能体可以直接使用你已登录的网站。",
  onboarding_browser_action: "从 Chrome 导入",
  onboarding_browser_done: "已导入。没有任何数据离开这台 Mac。",
  onboarding_skip: "跳过设置",
  onboarding_not_now: "暂不",
  onboarding_next: "下一步",
  onboarding_back: "上一步",
  onboarding_done: "完成",
  onboarding_browser_handoff: "接下来会打开 Chrome 导入。",
  onboarding_progress: (at: string, of: string) => `第 ${at} 步，共 ${of} 步`,
  ...
  "identity.manager.rename": "重命名配置文件",
  "identity.manager.delete": "删除配置文件",
  "identity.manager.deleteLastDisabled": "至少保留一个配置文件",
  "identity.manager.newIdentity": "新建配置文件",
  "identity.manager.newIdentityHint": "未登录任何网站",
  "identity.manager.setDefaultHint": "点击名称,新建节点即以它打开",
  "identity.manager.agentLabel": "代理",
  "identity.manager.agentAllowedOn": (name: string) =>
    `代理可以使用“${name}”工作。关闭后它只属于你。`,
  "identity.manager.agentAllowedOff": (name: string) =>
  ...
  browser_identity_manage: "管理配置文件…",
  browser_identity_guest_hint: "访客 — 未登录任何网站",
  browser_identity_signed_out: "未登录",
  browser_identity_agent_withheld: "不向代理开放 — 只属于你",
  browser_identity_agent_withheld_short: "不开放",
  "agentProfile.prompt.title": "在这个画布上,代理应使用哪个配置文件?",
  "agentProfile.prompt.body": (canvas: string) =>
    `只为“${canvas}”询问一次。代理使用某个配置文件时,能做你在其中能做的一切——以你的名义发信、发帖。随时可在浏览器配置文件中修改。`,
  "agentProfile.prompt.dismiss": "暂不选择",
  "agentProfile.prompt.dismissHint": "不做选择,此画布也不会再次询问。",
  "agentProfile.prompt.none":
    "目前没有可供代理使用的配置文件。请先在浏览器配置文件中允许一个。",
  "agentProfile.command.setCanvasDefault": "设置此画布的代理浏览器配置文件…",
