...
The extension never reads a browser profile directory, exports passwords, or copies cookies. It receives commands only for a tab that was explicitly granted. The local pairing expires after five minutes and creates a revocable install secret.
